...
def commandLine():
    ...
    while True:
        try:
            ...
            sendCommandToHost = True
            for a,b in enumerate(commandParts):
                if(b=="-nosend" or b=="-test" or b=="-client"):
                    sendCommandToHost = False
                    commandParts.pop(a)
           ...
           # print("Debug", dir(availableCommands))
            ...
            check = thread.start()
            #print('debug: end')
            if(functionName in clientOnlyFunctions or not sendCommandToHost):
                continue
            sendString = function+","
